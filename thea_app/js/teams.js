...
function displayTeams(teams){
	...
	$.each(teams, function (i, team){
		...
		var contact_person_first_name = team.contact_person.first_name
		var contact_person_last_name = team.contact_person.last_name
		var team_id = team.team_id
		var club_id = team.club.club_id
		var tablerow = '<tr><td><a href="./team.php?team_id=' + team_id +'">' + team_name + '</a></td><td>' + sport_id + '</td><td>' + 
